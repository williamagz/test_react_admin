...
const dataProviderUser = {
    ...
    getOne: async (resource, params) => {
        ...
        console.log(`${apiUrl}/products/detail/${params.id}`)
        try {
            const response = await axios.get(`${apiUrl}/${resource}/detail/${params.id}`)
    ...
    update: async (resource, params) => {
        // console.log("update", resource, params)
         try {
            const response = await axios.put(`${apiUrl}/${resource}/update`, params.data)
            // console.log("response",response.data) 
